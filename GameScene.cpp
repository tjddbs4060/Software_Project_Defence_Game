...
bool Game::init()
{
	...
	schedule(schedule_selector(Game::atk_boss));
...
void Game::create_boss(char* name, float hp, float def)
{
	char szFile[64] = { 0, };
